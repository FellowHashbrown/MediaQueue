...
a = Analysis(['main.py'],
             pathex=['/Users/fellowhashbrown/Desktop/Developing/Python/Projects/MediaQueue'],
             binaries=[],
             datas=[],
             hiddenimports=[],
             hookspath=[],
...
exe = EXE(pyz,
          ...
          runtime_tmpdir=None,
          console=False,
          icon="mediaqueue.ico" if sys.platform != "darwin" else "mediaqueue.icns")
